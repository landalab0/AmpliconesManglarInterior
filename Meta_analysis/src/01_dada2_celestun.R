...
fastq_path <- "results/02.cutadapt"
...
if (!dir.exists("results/03.dada2")) {
  dir.create("results/03.dada2", recursive = TRUE)
}

uniquesToFasta(PE.table_tsv_output, fout="results/03.dada2/ASVsCelestun.fasta", ids=paste("ASV_",1:ncol(PE.table_tsv_output), sep=""))
